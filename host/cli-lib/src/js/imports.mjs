export class JsBindgen {
    ...
    #jsEmbed;
    // @ts-expect-error: Used by generated closure factories.
    #jsExports;
    // @ts-expect-error: Used in placeholder.
    // eslint-disable-next-line no-unused-private-class-members
    #memory;
    ...
    async instantiate() {
        ...
        return WebAssembly.instantiate(this.#module, this.#importObject).then(instance => {
            ...
            this.#finished = true;
            // Export wrappers generated by `js-sys` use this stable binding.
            const wasmExports = instance.exports;
            this.#jsExports = JBG_PLACEHOLDER_JS_EXPORT;
            const exports = Object.assign(Object.create(null), wasmExports, this.#jsExports);
            return {
                instance,
                exports,
            };
