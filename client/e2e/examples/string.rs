...
fn main() {
	...
	// ;; exports["owned_roundtrip"]("Hello from JavaScript! 🦀") === "Hello from JavaScript! 🦀"
	// ;; exports["owned_roundtrip"]("\ufeffleading byte-order mark") === "\ufeffleading byte-order mark"
	// ;; exports["owned_roundtrip"]("\ud800") === "\ufffd"
	...
	// ;; exports["optional_owned_roundtrip"]("") === ""
...
#[js_sys]
fn borrowed_js_array(value: &Array) -> u32 {
	value.length()
}
